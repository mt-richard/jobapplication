            ...
            <div class="pr-60 pl-60 pt-14 h-[100vh] w-full bg-gray-800">
                <div class="flex  w-full pt-20">
                    <div class="w-1/2 pt-20 p-5 ">
                        ...
                        <a href="/login"><button class="ml-5 pr-10 pl-10 mt-5 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"  type="submit">Sign In</button></a>
                    </div>
                            ...
                            <h3 class="p-4 text-gray-700 font-bold text-xl border-b text-center">SignUp Page</h3>
                                ...
                                <div class=" w-full px-3 p-2 ">
                                    ...
                                    <div class="pb-1 text-center p-5">
                                        <p class="text-xs text-gray-600"> If you have Account, <a class="text-blue-500 font-bold"  href="/login">Sign In</a> </p>
                                    </div>
                                </div>
                        </form>
                    </div>
